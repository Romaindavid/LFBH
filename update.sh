...
echo "== 1/4 Collecte des nouveaux vols =="
python3 collect_history.py

echo
echo "== 2/4 Géolocalisation des nouveaux aéroports =="
python3 fetch_airport_coords.py

echo
echo "== 3/4 Reconstruction de dashboard_data.json =="
python3 build_dashboard_data.py

echo
echo "== 4/4 Photos des jets d'affaires =="
